...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    _titleL.textColor      = [UIColor colorWithRed:0.86 green:0.86 blue:0.86 alpha:1.00];
    ...
    _cWithTL.textColor     = [UIColor colorWithRed:0.81 green:0.81 blue:0.81 alpha:1.00];
