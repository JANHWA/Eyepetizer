...
@interface MRankViewController ()

@end

@implementation MRankViewController
...
- (void)loadData
{
    [MRankModel mj_setupReplacedKeyFromPropertyName:^NSDictionary *{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MRankModel *model       = _dataArray[indexPath.row];
